...
class UserAdditionalInfoViewModel with ChangeNotifier {
  ...
  UserAdditionalInfoViewModel({
    required currentUserStatus,
    required appUserRepository,
  })  : _appUserRepository = appUserRepository,
        _currentUserStatus = currentUserStatus;

  UserAdditionalInfoState get state => _state;
  UserAdditionalInfoState _state =
      UserAdditionalInfoState(isAbleNickName: false, forbiddenWord: "");

// UI Event
  Future<void> onEvent(UserAdditionalInfoEvent event,
