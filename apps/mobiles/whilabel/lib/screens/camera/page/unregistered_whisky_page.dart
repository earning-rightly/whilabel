...
class UnregisteredWhiskyPage extends StatefulWidget {
  ...
  @override
  State<UnregisteredWhiskyPage> createState() => _UnregisteredWhiskyPageState();
}

class _UnregisteredWhiskyPageState extends State<UnregisteredWhiskyPage> {
  String barcode = "";
  File? initImageFile;
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                Navigator.pushNamed(context,
                                    Routes.cameraRoutes.takePictureRoute,
                                    arguments: viewModel.state.cameras);
                              },
                              child: Text(
                                "다음",
