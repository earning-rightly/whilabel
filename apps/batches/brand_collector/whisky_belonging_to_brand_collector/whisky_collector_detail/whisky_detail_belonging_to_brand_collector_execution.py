from batches.whisky_collector.whisky_collector_detail import whisky_collector_detail_func
from batches.libs import libs_func
from batches.whisky_collector.whisky_collector_detail import whisky_collector_detail_values
