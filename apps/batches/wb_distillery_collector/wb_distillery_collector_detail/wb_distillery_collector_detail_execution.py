...
from batches.wb_distillery_collector.wb_distillery_collector_detail import wb_distillery_collector_detail_func
...
def distillery_detail_executions(mode = 'distillery', level = 'detail'):
    ...
    wb_libs_func.save_results(result_dict = detail_scrap, file_form ='wb_distillery_collector_detail')             #증류소 상세정보 저장 함수 호출
