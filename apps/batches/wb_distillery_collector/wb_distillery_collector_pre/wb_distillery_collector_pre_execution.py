...
from apps.batches.wb_distillery_collector.wb_distillery_collector_pre.wb_distillery_collector_pre_values import distillery_collect_pre_scrap as pre_scrap
...
def distillery_pre_executions(mode = 'distillery', level = 'early'):
    ...
    wb_libs_func.save_results(result_dict = pre_scrap, file_form ='wb_distillery_collector_pre')                    #증류소 사전정보 저장 함수 호출
