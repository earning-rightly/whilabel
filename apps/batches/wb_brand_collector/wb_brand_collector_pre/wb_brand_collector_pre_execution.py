from batches.wb_brand_collector.wb_brand_collector_pre import wb_brand_collector_pre_func
from batches.wb_brand_collector.wb_brand_collector_pre.wb_brand_collector_pre_values import brand_collect_pre_scrap as pre_scrap
...
def brand_pre_executions(mode = 'brand', level = 'early'):
    ...
    wb_libs_func.save_results(result_dict = pre_scrap, file_form ='wb_brand_collector_pre')                        #브랜드 사전정보 저장 함수 호출
