...
def brand_pre_executions(batch_type : BatchType):
    ...
    scrap_dict = wb_libs_func.initialize_dict(pre_field_map['wb_brand_collect_pre'])

    wb_brand_collector_pre_func.collect(scrap_dict, pre_link_map['brand'])  # 증류소 사전정보 수집 함수 호출
