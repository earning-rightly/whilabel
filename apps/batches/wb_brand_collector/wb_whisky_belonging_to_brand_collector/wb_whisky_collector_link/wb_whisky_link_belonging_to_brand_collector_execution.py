...
def whisky_link_brand_collector_executions(mode = 'brand', level = 'link'):  #mode allows you to choose between distilleries and brands to collect { mode : distillery, brand} * default = distillery
    """
    ...
    wb_libs_func.save_resconvert_csv_to_json(result_dict = link_scrap, file_form ='wb_brand_whisky_collector_link')                #위스키 링크 저장 함수 호출
