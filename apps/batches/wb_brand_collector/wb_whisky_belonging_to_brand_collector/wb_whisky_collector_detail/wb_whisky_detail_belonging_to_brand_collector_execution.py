from apps.atches.wb_whisky_collector.wb_whisky_collector_detail import wb_whisky_collector_detail_func
...
def whisky_detail_brand_collector_executions(mode = 'brand', level ='detail'):
    ...
    wb_libs_func.save_resconvert_csv_to_json(result_dict = whisky_detail_scrap, file_form='wb_brand_whisky_collector_detail')      #브랜드 상세정보 저장 함수 호출
