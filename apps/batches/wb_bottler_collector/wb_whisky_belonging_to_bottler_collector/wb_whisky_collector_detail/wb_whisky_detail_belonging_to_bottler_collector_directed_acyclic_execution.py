...
def whisky_detail_bottler_collector_executions(mode='bottler', level='detail'):
    """
    ...
    wb_whisky_collector_detail_func.collect(mode, current_date=wb_libs_func.extract_time()[0])  # 위스키 사전정보 수집 함수 호출
