...
def replace_extracted_data_with_wb_brand_formmat(batchId : str = None) -> [list, dict]:
    ...
    brand_detail_data = pd.read_csv(f'/Users/choejong-won/PycharmProjects/whilabel/apps/batches/results/{current_date}/csv/detail/{BatchType.BRAND_DETAIL.value}.csv')
    brand_summary_data = pd.read_csv(f'/Users/choejong-won/PycharmProjects/whilabel/apps/batches/results/{current_date}/csv/pre/{BatchType.BRAND_PRE.value}.csv')
